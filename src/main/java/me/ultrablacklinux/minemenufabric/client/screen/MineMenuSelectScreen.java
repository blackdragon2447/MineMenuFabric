    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (repeatButton.isMouseOver(mouseX, mouseY)) {
            if (button == 1 && repeatDatapath != null) {
                isRepeatEdit = true;
                try {
                    client.setScreen(new MineMenuSettingsScreen(this, true));
                } catch (Exception e) {
                    e.printStackTrace();
                }
                return true;
    ...
    private void handleTypes(JsonObject value) {
        ...
        switch (type) {
            ...
            case "category":
                ...
                client.setScreen(new MineMenuSelectScreen(value.get("data").getAsJsonObject(),
            ...
            case "chatbox":
                close();
                client.setScreen(new ChatScreen(value.get("data").getAsString()));
                break;
